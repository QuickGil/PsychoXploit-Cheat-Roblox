local Config = {
    WindowName = "PsychoXploit Cheat Menu",
...
game:GetService("RunService").RenderStepped:Connect(
    function()
        ...
        if ClosestPlayer then
            ...
            mousemoverel(
                (TargetPos.X - Mouse.X) * getgenv().AimBot.Smoothness,local
...
local Button1 = Section2:CreateButton("Ganti Server", function()
...
Title = "PsychoXploit";
Text = "klik ctrl kanan untuk membuka menu";
})

game.StarterGui:SetCore("SendNotification", {
Title = "Warning";
Text = "Cheat ini memiliki kemungkinan untuk terkena ban";
})
